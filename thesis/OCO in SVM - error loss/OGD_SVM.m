%%% Online Gradient Descent for Support Vector Machine with static memory.
%%% Selects n random datasamples and uses these to optimize the model based
%%% on the squared prediction error (simplified with tanh). 
clear
close all
clc
...
train_time = toc;
%% Visualize
visualize(XC,YC,a,b,K,X(1:1000,:),Y(1:1000))
%% Calculate accuracy
eval_n = 1000;
